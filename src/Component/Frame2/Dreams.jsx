    ...
    return(
        ...
        <div className="blockDream">
            ...
            <div className="infoBlockDream">
                <h2>Created by the world's top scientists</h2>
                <p>Our expert team leads three of the largest nutrition research studies with scientists at the world’s most respected research institutions.</p>
            </div>
        </div>
